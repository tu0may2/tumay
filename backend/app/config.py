...
class Settings(BaseSettings):
    ...
    # живёт в таблице баров и не страдает, а срезы недельной давности не
    ...
    quote_prune_batch: int = 5000
    # Потолок за один заход. Остаток уберётся в следующем цикле —
    # первая уборка на запущенной базе иначе растянулась бы надолго
    quote_prune_max_rows: int = 50000
